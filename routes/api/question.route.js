...
const isQuestionExists = await Question.find({question});
...
if(question && Object.keys(question).length){
    return apiHelper.success(res,{question}, ERROR_LITERAL.QUESTIONS.CREATE_QUESTIONS.SUCCESS)
}
...
router.get(`${ROUTES.QUESTIONS.GET_ALL_QUESTIONS.URL}`, async(req,res,next)=>{
    try{
        ...
        if(question && Object.keys(question).length){
            return apiHelper.success(res,{question}, ERROR_LITERAL.QUESTIONS.GET_ALL_QUESTIONS.SUCCESS)
        }
...
if(question&& Object.keys(question).length)
{
    return apiHelper.success(res,{question}, ERROR_LITERAL.QUESTIONS.GET_QUESTIONS.SUCCESS)
}
        return apiHelper.failure(res,[], ERROR_LITERAL.COMMON_MSG.DATA_NOT_FOUND)
...
if(question&& Object.keys(question).length)
{
    return apiHelper.success(res,{question}, ERROR_LITERAL.QUESTIONS.UPDATE_QUESTIONS.SUCCESS)
}
...
if(question&& Object.keys(question).length)
{
    return apiHelper.success(res,{question}, ERROR_LITERAL.QUESTIONS.DELETE_QUESTIONS.SUCCESS)
}

...
const isAnswerExists = await Answer.find({answer});
...
if(answer && Object.keys(answer).length){
    return apiHelper.success(res,{answer}, ERROR_LITERAL.ANSWERS.CREATE_ANSWERS.SUCCESS)
}
...
router.get(`${ROUTES.ANSWERS.GET_ALL_ANSWERS.URL}`, async(req,res,next)=>{
    try{
        ...
        if(answers && Object.keys(answers).length){
            return apiHelper.success(res,{answers}, ERROR_LITERAL.ANSWERS.GET_ALL_ANSWERS.SUCCESS)
        }
...
if(answer&& Object.keys(answer).length)
{
    return apiHelper.success(res,{answer}, ERROR_LITERAL.ANSWERS.GET_ANSWERS.SUCCESS)
}
        return apiHelper.failure(res,[], ERROR_LITERAL.COMMON_MSG.DATA_NOT_FOUND)
...
if(answer&& Object.keys(answer).length)
{
    return apiHelper.success(res,{answer}, ERROR_LITERAL.ANSWERS.UPDATE_ANSWERS.SUCCESS)
}
...
if(answer&& Object.keys(answer).length)
{
    return apiHelper.success(res,{answer}, ERROR_LITERAL.ANSWERS.DELETE_ANSWERS.SUCCESS)
}
